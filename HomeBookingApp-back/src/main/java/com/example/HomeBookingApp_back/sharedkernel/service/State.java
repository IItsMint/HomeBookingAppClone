package com.example.HomeBookingApp_back.sharedkernel.service;

//The idea is make the service return this state with inside some status about what happened in service and what is the result
